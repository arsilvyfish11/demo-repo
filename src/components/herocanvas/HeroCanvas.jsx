...
import heroImage from '../../assets/4833725.svg';
...
const HeroCanvas = ({ images }) => {
  ...
  return (
    <div style={{ textAlign: 'center' }}>
      ...
      <button
        className='text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-10 py-3 text-center dark:bg-gray-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800'
